...
public class KkRepoMetrics {
  ...
  public KkRepoMetrics(MeterRegistry registry) {
  ...
  public void recordBlobOperation(
    ...
    Counter.builder("kkrepo_blob_storage_operations_total")
        .description("Blob storage operations by store and backend")
        .tags(tags)
        .register(registry)
        .increment();
    sample.stop(Timer.builder("kkrepo_blob_storage_operation_duration")
  ...
  public void recordBlobBytes(String store, String type, String engine, String operation, long bytes) {
    Tags tags = Tags.of(
        ...
        "engine", tagValue(engine),
        "op", tagValue(operation));
    recordBytes("kkrepo_blob_storage_bytes_total",
  ...
  public void recordWorkerBatch(String worker, String outcome, Timer.Sample sample) {
    ...
    sample.stop(Timer.builder("kkrepo_worker_batch_duration")
  ...
  public void recordWorkerItem(String worker, String kind, String outcome, Timer.Sample sample) {
    Tags tags = Tags.of(
        ...
        "kind", tagValue(kind),
        "outcome", tagValue(outcome));
    Counter.builder("kkrepo_worker_items_total")
        .description("Background worker items processed")
        .tags(tags)
        .register(registry)
        .increment();
    sample.stop(Timer.builder("kkrepo_worker_item_duration")
  ...
  public void incrementBlobGcDeletedBytes(long bytes) {
    recordBytes("kkrepo_blob_gc_deleted_bytes_total", "Blob bytes deleted by GC", bytes, Tags.empty());
  }

  public void incrementBlobGcReconcile(long scanned, long marked) {
    recordBytes("kkrepo_blob_gc_reconcile_scanned_total",
        "Blob rows scanned by orphan reconcile", scanned, Tags.empty());
    recordBytes("kkrepo_blob_gc_reconcile_marked_total",
  ...
  public void recordProxyCacheEvent(RepositoryRuntime runtime, String result) {
    ...
    Counter.builder("kkrepo_proxy_cache_events_total")
  ...
  public void recordProxyRemote(
    ...
    Tags tags = Tags.of(
        ...
        "status", Integer.toString(Math.max(0, status)),
        "outcome", outcome(status, failure));
    Counter.builder("kkrepo_proxy_remote_requests_total")
        .description("Proxy upstream HTTP requests")
        .tags(tags)
        .register(registry)
        .increment();
    sample.stop(Timer.builder("kkrepo_proxy_remote_duration")
  ...
  public void recordRateLimitBlocked(String type) {
    Counter.builder("kkrepo_rate_limit_blocked_total")
