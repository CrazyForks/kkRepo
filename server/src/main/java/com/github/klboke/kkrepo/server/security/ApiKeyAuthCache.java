...
public class ApiKeyAuthCache {
  ...
  public ApiKeyAuthCache(
      ...
      @Value("${kkrepo.cache.api-key.enabled:true}") boolean enabled,
      @Value("${kkrepo.cache.api-key.ttl-seconds:60}") long ttlSeconds,
      @Value("${kkrepo.cache.api-key.missing-ttl-seconds:5}") long missingTtlSeconds) {
